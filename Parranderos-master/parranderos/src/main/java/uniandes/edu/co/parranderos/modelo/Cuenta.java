...
public class Cuenta {
    ...
    private Integer DOCUMENTOIDENTIDICACIONNUMERO;
    ...
    this.ESTADO = ESTADO;
    this.DOCUMENTOIDENTIDICACIONNUMERO = DOCUMENTOIDENTIDICACION;
    }
    ...
    public Integer getDOCUMENTOIDENTIDICACIONNUMERO() {
        return DOCUMENTOIDENTIDICACIONNUMERO;
    }
    ...
    public void setDOCUMENTOIDENTIDICACIONNUMERO(Integer dOCUMENTOIDENTIDICACION) {
        DOCUMENTOIDENTIDICACIONNUMERO = dOCUMENTOIDENTIDICACION;
    }
